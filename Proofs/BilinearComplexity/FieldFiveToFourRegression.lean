...
/-- The ternary field used throughout the public scanner/contraction regressions. -/
...
/-- Bounded scanner/contraction data for the first-mode source/source fixture. -/
def bridgeFirst01 := certifiedFiveToFour first01

/-- Bounded scanner/contraction data for the first-mode target/target fixture. -/
def bridgeFirst23 := certifiedFiveToFour first23

/-- Bounded scanner/contraction data for the first-mode forward-opposite fixture. -/
def bridgeFirst02 := certifiedFiveToFour first02

/-- Bounded scanner/contraction data for the first-mode reverse-opposite fixture. -/
